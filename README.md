...
Recebe a pergunta via endpoint /perguntas.
Envia a pergunta para o Ollama gerar uma consulta SQL segura.
Executa a consulta no PostgreSQL (somente leitura, com limitações de segurança).
Retorna as linhas ao Ollama para modelagem da resposta textual.
Entrega a resposta final ao consumidor da API.
Requisitos
Python 3.11+
